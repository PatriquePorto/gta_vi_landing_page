      ...
      <div className="flex flex-col gap-5 items-end img-box lg:1/2 ps-10 mt-96">
        ...
        <div className="lucia-3">
         ...
         <div className='max-w-xl lg:ps-32 ps-10'>
            ...
            <p>
              Life has been coming at her swinging ever since. Fighting for her family landed her 
              in the Leonida Panitentiary. Sheer luck got her out. Lucia's learned her lesson - 
        ...
        <div className="lucia-2">
          ...
          <p className='max-w-xl lg:ps-32 ps-10'>
            More than anything, Lucia wants the good life her mon has dreamed of since their days in Liberty City - 
            but instead of half-baked fantasies, Lucia is prepared to take matters into her own hands.
          </p>
      </div>
    </section>
  )
